...
public class OryHydraService {
    ...
    public OryHydraService(Environment env) {
        ...
        this.oryHydraAdminEndPoint = WebClient
                ...
                // Since Ory Hydra is configured for TLS termination, the header below is required
    ...
    /**
     * <p>
     * check whether the user was authenticated before and remembered himself in the system?
